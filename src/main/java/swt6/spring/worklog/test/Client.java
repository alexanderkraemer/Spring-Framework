...
import swt6.spring.worklog.logic.WorkLogImpl;
import swt6.spring.worklog.ui.UIProcessComponent;
...
public class Client {
    ...
    private static void insertData(){
        Employee e = new Employee("Alexander", "Krämer", new Date(1995, 6, 18));
        fc.syncEmployee(e);
    }
    ...
    public static void main(String[] args) {
        ...
        fc = appCtx.getBean("workLog", WorkLogFacade.class);

        UIProcessFacade cp = new UIProcessComponent();
